...
Function PostWikiPage{
    ...
    for($i = 1; $i -le $pathParts.Length -1; $i++)
    {
        ...
        {           
            ...
            $wikiPage = GetWikiPage -PersonalAccessToken $secret.SecretValueText  -Organization $Organization -Project $Project -WikiId $wikiId -PagePath $ancestorPath;
        ...
        {            
            ...
            try {
                ...
                $result = CallAdoApi -Method "PUT" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis/$($WikiId)/pages?path=$($ancestorPath)&api-version=$($currentApiVersion)" -BodyObject $ancestorBodyObject;
    ...
    try
    {
        ...
        $wikiPage = GetWikiPage -PersonalAccessToken $secret.SecretValueText  -Organization $Organization -Project $Project -WikiId $wikiId -PagePath $PagePath;
        ...
        $result = CallAdoApi -Method "PUT" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis/$($WikiId)/pages?path=$($PagePath)&api-version=$($currentApiVersion)" -BodyObject $bodyObject -Headers $headers;
    ...
    catch
    {
        try 
        {
            ...
            $result = CallAdoApi -Method "PUT" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis/$($WikiId)/pages?path=$($PagePath)&api-version=$($currentApiVersion)" -BodyObject $bodyObject;
...
Function GetWikiPage{
    ...
    $response = CallAdoApi -Method "GET" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis/$($WikiId)/pages?path=$($PagePath)&api-version=$($currentApiVersion)"
...
Function GetWikis{
    ...
    $response = CallAdoApi -Method "Get" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis?api-version=$($currentApiVersion)";
...
Function GetWiki{
    ...
    $response = CallAdoApi -Method "Get" -PersonalAccessToken $PersonalAccessToken -Organization $Organization -Project $Project -ApiPathAndQuery "wiki/wikis/$($WikiName)?api-version=$($currentApiVersion)";
