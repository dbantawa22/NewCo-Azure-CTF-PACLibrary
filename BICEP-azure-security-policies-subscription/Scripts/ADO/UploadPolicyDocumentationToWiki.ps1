...
$getWikiInfoBlock = {
    $wikiInfo = GetWiki -PersonalAccessToken $secret.SecretValueText -Organization $Organization -Project $Project -WikiName $WikiName;
...
foreach($file in $files)
{
    ...
    $postWikiPageBlock = {
        ...
        PostWikiPage -PersonalAccessToken $secret.SecretValueText  -Organization $Organization -Project $Project -WikiId $wiki.value.id -PagePath $($pagePath) -Content $pageContent -Verbose:$VerbosePreference;
