...
resource 83a86a26-fd1f-447c-b59d-e51f44264114 'Microsoft.Authorization/policydefinitions' existing = {
...
resource initiative_Global 'Microsoft.Authorization/policySetDefinitions@2020-09-01' = {
	...
	properties: {
		...
		policyDefinitions: [
			...
			// {  
			// 		policyDefinitionId: 83a86a26-fd1f-447c-b59d-e51f44264114.id
			// 		parameters: {
