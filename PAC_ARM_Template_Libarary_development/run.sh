...
connect_deployment()
{
    ...
    az deployment mg create --location uksouth --management-group-id MGMT_ROOT --template-file  ./policyset_not_allowed_resource_types.json.json --name policy-Deployment-17
