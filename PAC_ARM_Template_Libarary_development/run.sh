...
connect_deployment()
{
    ...
    az deployment mg create --location uksouth --management-group-id MGMT_ROOT --name policy-set-assignment-keyvault-purgeprotection --template-file ./Assignments/assignment_keyvault.json --parameters ./Parameters/assignment_keyvault.purgeprotection.parameters.json
