...
connect_deployment()
{
    ...
    az deployment mg create --location uksouth --management-group-id MGMT_ROOT --template-file ./DENY-PublicIpAddressPolicyAssignment.json --name policy-Deployment-10
