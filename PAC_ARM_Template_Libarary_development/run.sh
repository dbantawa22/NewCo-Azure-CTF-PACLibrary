...
connect_deployment()
{
    ...
    az deployment sub create --location southuk --name policy-set-definition-allowed_locations_southuk --template-file ./PolicySetDefinitions/policyset_allowed_locations.json --parameters ./Parameters/assignment_allowed_locations_suk.parameters.json
    ...
    az deployment sub create --location southuk --name policy-set-assignment-allowed_locations_southuk --template-file ./Assignments/assignment_allowed_locations.json --parameters ./Parameters/assignment_allowed_locations_suk.parameters.json
